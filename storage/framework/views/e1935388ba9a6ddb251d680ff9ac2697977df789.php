...
} elseif ($_instance->childHasBeenRendered('J2IUnUh')) {
    $componentId = $_instance->getRenderedChildComponentId('J2IUnUh');
    $componentTag = $_instance->getRenderedChildComponentTagName('J2IUnUh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('J2IUnUh');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('J2IUnUh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /Users/asadbekfayzulloev/server/anysoft_pro/vendor/filament/filament/src/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>