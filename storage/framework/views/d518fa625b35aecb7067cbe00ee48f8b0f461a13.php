...
} elseif ($_instance->childHasBeenRendered('AuU915F')) {
    $componentId = $_instance->getRenderedChildComponentId('AuU915F');
    $componentTag = $_instance->getRenderedChildComponentTagName('AuU915F');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AuU915F');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('AuU915F', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('QrwZ5wu')) {
    $componentId = $_instance->getRenderedChildComponentId('QrwZ5wu');
    $componentTag = $_instance->getRenderedChildComponentTagName('QrwZ5wu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('QrwZ5wu');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('QrwZ5wu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Users/asadbekfayzulloev/server/anysoft_pro/vendor/filament/filament/src/../resources/views/components/topbar.blade.php ENDPATH**/ ?>