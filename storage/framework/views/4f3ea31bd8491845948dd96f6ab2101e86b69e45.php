...
} elseif ($_instance->childHasBeenRendered('TPUqgMH')) {
    $componentId = $_instance->getRenderedChildComponentId('TPUqgMH');
    $componentTag = $_instance->getRenderedChildComponentTagName('TPUqgMH');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TPUqgMH');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('TPUqgMH', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('qR4lEnu')) {
    $componentId = $_instance->getRenderedChildComponentId('qR4lEnu');
    $componentTag = $_instance->getRenderedChildComponentTagName('qR4lEnu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qR4lEnu');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('qR4lEnu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH /Users/asadbekfayzulloev/server/anysoft_pro/resources/views/vendor/filament/components/topbar.blade.php ENDPATH**/ ?>