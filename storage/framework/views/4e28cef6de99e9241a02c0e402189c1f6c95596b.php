...
} elseif ($_instance->childHasBeenRendered('1Yi3rqr')) {
    $componentId = $_instance->getRenderedChildComponentId('1Yi3rqr');
    $componentTag = $_instance->getRenderedChildComponentTagName('1Yi3rqr');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('1Yi3rqr');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('1Yi3rqr', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /Users/asadbekfayzulloev/server/anysoft_pro/resources/views/vendor/filament/components/layouts/card.blade.php ENDPATH**/ ?>